...
export class AppComponent {
  ...
  images:Array<{title: string, url: string}> = [
    ...
    },
    {
      ...
      url: 'https://images.unsplash.com/photo-1465056836041-7f43ac27dcb5?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8M3x8bW91bnRhaW58ZW58MHx8MHx8&auto=format&fit=crop&w=500&q=60'
    },
    {
      title: 'At the city',
  ...
  checkWindowIndex(index: number){
    return Math.abs(this.currIndex - index) < 5;
  }
}
